    ...
    public class CreateMapDataEditor : EditorWindow
    {
        ...
        private void PreviewMapData()
        {
            ...
            if (mapDataPrefabPathSimple)
            {
                for (int i = 0; i < selectGameObjectDatas.Count; i++)
                {
                    ObjData objData = new ObjData(selectGameObjectDatas[i].objPrefabPathSimple,new Vector3Int((int)selectGameObjectDatas[i].obj.transform.position.x,(int)selectGameObjectDatas[i].obj.transform.position.y) , selectGameObjectDatas[i].obj.transform.rotation, selectGameObjectDatas[i].obj.transform.localScale, selectGameObjectDatas[i].objModelSize);
            ...
            else
            {
                for (int i = 0; i < selectGameObjectDatas.Count; i++)
                {
                    ObjData objData = new ObjData(selectGameObjectDatas[i].objPrefabPath,new Vector3Int((int)selectGameObjectDatas[i].obj.transform.position.x,(int)selectGameObjectDatas[i].obj.transform.position.y), selectGameObjectDatas[i].obj.transform.rotation, selectGameObjectDatas[i].obj.transform.localScale, selectGameObjectDatas[i].objModelSize);
                    objDataContainer.objDatas[i] = objData;
                }
            }
